...
export interface IBTxContract extends Truffle.Contract<IBTxInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IBTxInstance>;
}
...
export interface IBTxInstance extends Truffle.ContractInstance {
