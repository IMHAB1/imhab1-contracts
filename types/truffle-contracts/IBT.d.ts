...
export interface IBTContract extends Truffle.Contract<IBTInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IBTInstance>;
}
...
export interface IBTInstance extends Truffle.ContractInstance {
